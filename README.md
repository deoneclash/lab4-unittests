...
3. Выполнение тестов: запуститьать отчёт и инструкции по запуску.4. Сохранение результатов в протоколе тестирования.

---

## История версий 
- initial commit: добавленызать методику на# Отчет по лабораторн# Отчет по лабора# Отчет по ла
---

## Фактический результат выполнения тестов t тестов
